        ...
        lista.forEach(os => {
            ...
            <div class="card-dark p-4 relative overflow-hidden mb-3">
                ...
                <div class="flex justify-between items-start mb-3">
                    <div class="flex items-center gap-3"><div class="w-8 h-8 rounded-full bg-[#1a1a1a] flex items-center justify-center text-gray-400"><i class="fa-solid fa-car-side"></i></div><div><h3 class="font-bold text-sm leading-none uppercase text-white">${os.modelo_veiculo}</h3><span class="text-[10px] font-mono text-accent">${os.placa}</span></div></div>
